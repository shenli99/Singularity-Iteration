...
public class AdvancedJetpackCurioItem implements ICurioItem {
    @Override
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        if (!chestStack.isEmpty() && chestStack.getItem() instanceof mio_icif_chestplate_advanced_jetpack)
            return;

        if (stack.getItem() instanceof mio_icif_chestplate_advanced_jetpack chest) {
